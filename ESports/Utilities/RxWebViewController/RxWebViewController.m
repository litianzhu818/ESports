...
@property (nonatomic)UIBarButtonItem* originalButtonItem;
...
{
    return [self initWithUrl:url backBlock:NULL];
}
...
-(void)updateNavigationItems{
    ...
    if (self.webView.canGoBack) {
        ...
        if (self.navigationItem.leftBarButtonItems.count > 1) {
            ...
            self.navigationItem.leftBarButtonItem = self.originalButtonItem;
        }
    }
}
...
-(UIBarButtonItem*)closeButtonItem{
    if (!_closeButtonItem) {
        ...
        [backButton setTitle:@"关闭" forState:UIControlStateHighlighted];
        [backButton setTitleColor:self.navigationController.navigationBar.tintColor forState:UIControlStateNormal];
        [backButton setTitleColor:[self.navigationController.navigationBar.tintColor colorWithAlphaComponent:0.5] forState:UIControlStateHighlighted];
        [backButton.titleLabel setFont:[UIFont systemFontOfSize:17]];
        [backButton sizeToFit];
