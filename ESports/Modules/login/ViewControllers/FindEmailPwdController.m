...
@interface FindEmailPwdController ()
...
@implementation FindEmailPwdController
...
- (void)viewDidLoad {
    ...
    self.localStringDictionary = @{
                                   SYS_LANGUAGE_ENGLISH:@{
                                           ...
                                           @"email_no_use_title":@"This email has not been registered！"
                                           },
                                   SYS_LANGUAGE_S_CHINESE:@{
                                           @"view_controller_title":@"找回密码",
                                           @"no_email_tile":@"请填写邮箱",
                                           @"email_formart_error_title":@"邮箱格式错误",
                                           @"email_no_use_title":@"该邮箱未被注册！"
                                           },
                                   SYS_LANGUAGE_T_CHINESE:@{
                                           @"view_controller_title":@"找回密码",
                                           @"no_email_tile":@"請填寫郵箱",
                                           @"email_formart_error_title":@"郵箱格式錯誤",
                                           @"email_no_use_title":@"該郵箱未被註冊！"
                                           }
                                   };
...
- (void)findEmailPwdAction
{
    ...
    [[HttpSessionManager sharedInstance] findPwdWithEmail:self.email
