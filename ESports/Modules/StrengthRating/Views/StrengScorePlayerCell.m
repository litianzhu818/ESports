...
@interface StrengScorePlayerCell ()
...
@implementation StrengScorePlayerCell
...
- (void)setPlayer:(StrengScorePlayer *)player
{
    _player = player;
...
- (void)layoutSubviews
{
    ...
    self.rankingTitleLabel.text = self.player.playerRanking;
    [self.teamImageView sd_setImageWithURL:[NSURL URLWithString:self.player.playerImageUrl] placeholderImage:[UIImage imageNamed:@"占位图片"]];
    self.nameTitleLabel.text = self.player.playerName;
    [self.regionImageView sd_setImageWithURL:[NSURL URLWithString:self.player.playerRegionImageUrl] placeholderImage:[UIImage imageNamed:@"占位图片"]];
    self.scoreTitleLabel.text = self.player.playerStrength;
}

#pragma mark - class methods
+ (UINib *)nib
{
    return [UINib nibWithNibName:NSStringFromClass([StrengScorePlayerCell class])
                          bundle:[NSBundle bundleForClass:[StrengScorePlayerCell class]]];
}

+ (NSString *)cellIdentifier
{
    return NSStringFromClass([StrengScorePlayerCell class]);
}
