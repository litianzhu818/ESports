...
@interface StrengScorePlayerTopCell ()
...
@implementation StrengScorePlayerTopCell
...
+ (UINib *)nib
{
    return [UINib nibWithNibName:NSStringFromClass([StrengScorePlayerTopCell class])
                          bundle:[NSBundle bundleForClass:[StrengScorePlayerTopCell class]]];
}

+ (NSString *)cellIdentifier
{
    return NSStringFromClass([StrengScorePlayerTopCell class]);
}
